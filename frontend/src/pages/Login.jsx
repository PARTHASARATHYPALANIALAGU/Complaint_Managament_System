    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-md glass-card p-8 animate-fade-in relative overflow-hidden">
                ...
                <div className="absolute -top-32 -right-32 w-64 h-64 bg-blue-600/20 rounded-full blur-3xl rounded-full" />
                <div className="absolute -bottom-32 -left-32 w-64 h-64 bg-indigo-600/20 rounded-full blur-3xl rounded-full" />

                <div className="relative text-center mb-8">
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
                        Welcome Back
                    </h1>
                    <p className="text-white/60 mt-2">Login to your CampusVoice account</p>
                </div>
